...
<form action="add_productsdata.php" method="post" enctype="multipart/form-data">
					...
					<textarea style="background-color:wheat" class="text" type="text" name="small_description" placeholder="Enter Small Description" required="" rows=3 cols="50"></textarea><hr>
					...
					<input  style="background-color:wheat" class="text email" type="text" name="org_price" placeholder="Enter Original Price" required="" size=50><hr>
					<input  style="background-color:wheat" class="text email" type="text" name="sell_price" placeholder="Enter Selling Price" required="" size=50><hr>

                    <label>Upload Image:</label><input style="background-color:wheat" type="file" name="pimage" value=""><hr>
					<input  style="background-color:wheat" class="text email" type="text" name="qty" placeholder="Enter Quantity" required="" size=50><hr>
                    <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    ...
                    <textarea style="background-color:wheat" class="text" type="text" name="meta_keywords" placeholder="Enter Meta Keywords" required="" rows=3 cols="50"></textarea><hr>
